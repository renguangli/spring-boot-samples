    ...
    var a = layui.jquery, i = layui.laytpl, t = layui.element, l = layui.setter, n = layui.view, s = layui.device(),
        ...
        x = "layui-icon-spread-left", C = "layadmin-side-shrink", k = "LAY-system-side-menu", F = {
            v: "1.0.0 std", req: n.req, sendAuthCode: function (e) {
                ...
                "styleSheet" in s ? (s.setAttribute("type", "text/style"), s.styleSheet.cssText = r) : s.innerHTML = r, s.id = n, u && o[0].removeChild(u), o[0].appendChild(s), o.attr("layadmin-themealias", e.color.alias), t.theme = t.theme || {}, layui.each(e, function (e, a) {
                    t.theme[e] = a
            ...
            flexible: function (e) {
                ...
                F.popupRight({
                    id: "LAY_adminPopupAbout", success: function () {
                        n(this.id).render("about")
                    }
                })
            }, more: function () {
                F.popupRight({
                    id: "LAY_adminPopupMore", success: function () {
                        n(this.id).render("more")
                    }
                })
            }, back: function () {
                history.back()
